...
class CoreMLKitModule extends BaseModule {
  ...
  Future<void> registerDependency(GetIt c) async {
    c
      ..registerLazySingleton<IFaceDetectorRepository>(() => FaceDetectorRepository())
      ..registerLazySingleton<IImageLabelingRepository>(() => ImageLabelingRepository())
      ..registerLazySingleton<IObjectDetectorRepository>(() => ObjectDetectorRepository());
  }
}
